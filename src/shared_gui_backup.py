...
def get_teleoperation_frame(window, mqtt_sender):
    ...
    desired_distance_for_ir_sensor_button_backwards.grid(row=14,column=1)
    desired_distance_for_ir_sensor_button_forwards.grid(row=15,column=1)
    desired_distance_for_ir_sensor_button_smart.grid(row=16,column=1)
    spin_clockwise_until_object.grid(row=9, column=1)
    spin_clockwise_speed_label.grid(row=10, column=1)
    spin_clockwise_area_label.grid(row=12, column=1)
    spin_clockwise_entry_speed.grid(row=11, column=1)
    spin_clockwise_entry_area.grid(row=13, column=1)
    spin_counterclockwise_until_object.grid(row=9, column=2)
    spin_counterclockwise_speed_label.grid(row=10, column=2)
    spin_counterclockwise_area_label.grid(row=12, column=2)
    spin_counterclockwise_entry_speed.grid(row=11, column=2)
    spin_counterclockwise_entry_area.grid(row=13, column=2)
    ...
    go_until_color_is_button['command'] =lambda: handle_go_until_color_is(mqtt_sender,
                                                                          color_entry,right_speed_entry)
    spin_clockwise_until_object['command'] = lambda: handle_spin_clockwise_until_object(mqtt_sender,
                                                                                        spin_clockwise_entry_area, spin_clockwise_entry_speed)
    spin_counterclockwise_until_object['command'] = lambda: handle_spin_counterclockwise_until_object(mqtt_sender, spin_counterclockwise_entry_area, spin_counterclockwise_entry_speed)
